...
export const getApiKeyValidate = (apiKey) => {
    if (!apiKey) {
        return {
            content: [{
                    type: "text",
...
export const handleReGeocode = async (location) => {
...
export const handleGeo = async (address, city, sig) => {
...
export const handleIPLocation = async (ip) => {
...
export const handleWeather = async (city) => {
...
export const handleSearchDetail = async (id) => {
...
export const handleBicycling = async (origin, destination) => {
...
export const handleWalking = async (origin, destination) => {
...
export const handleDriving = async (origin, destination) => {
...
export const handleTransitIntegrated = async (origin, destination, city = "", cityd = "") => {
...
export const handleDistance = async (origins, destination, type = "1") => {
...
export const handleTextSearch = async (keywords, city = "", citylimit = "false") => {
...
export const handleAroundSearch = async (location, radius = "1000", keywords = "") => {
